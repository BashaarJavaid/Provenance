...
- `./scripts/gcp_setup.sh` — GCP project, APIs (incl. Cloud Trace and Cloud Run), the Cloud Build IAM grant, Firestore, and a live Gemini access probe; idempotent. `PROJECT_ID` / `REGION` override the defaults (`provenance-hackathon`, `us-central1`)
